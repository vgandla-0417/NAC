...
@Component({
  ...
  templateUrl: "Courier-Entry.component.html",
  styleUrls : ["Courier-Entry.component.css"]
})
export class CourierEntryComponent implements OnInit {
...
// _Replacestr:any="D:/WW/14-Jully-2020/UI/src/assets";
  ...
  ngOnInit(){
    ...
    this.PODEntryForm = this.formBuilder.group({
       id: [""],
       batch_id:[0, Validators.required],
    ...
    //this.PODEntryForm.controls['batch_id'].setValue(0);
